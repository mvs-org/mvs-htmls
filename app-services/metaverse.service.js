(function () {
    ...
    function MetaverseService($http, localStorageService) {
        ...
        var SERVER2 = "127.0.0.1:8821";

        var RPC_URL = 'http://' + SERVER + '/rpc';
        var RPC_URL_V2 = 'http://' + SERVER + '/rpc/v2';
        var RPC_URL_V3 = 'http://' + SERVER + '/rpc/v3';
        ...
        service.hasIcon = ['ETP', 'MVS.ZGC', 'MVS.ZDC', 'CSD.CSD', 'PARCELX.GPX', 'PARCELX.TEST', 'SDG', 'META', 'MVS.HUG', 'RIGHTBTC.RT', 'TIPLR.TPC', 'PANDO', 'VALOTY', 'KOALA.KT', 'DNA', 'GKC', 'DAY', 'APO', 'JKB', 'DIA'];
